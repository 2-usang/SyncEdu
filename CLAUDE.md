...
/src/app/(auth)/ — 인증 페이지 (A 담당)
/src/components/student/ — 학생 화면 컴포넌트 (A 담당)
/src/components/instructor/ — 강사 화면 컴포넌트 (B 담당)
/src/components/common/ — 공통 컴포넌트 (수정 시 팀 알림)
/src/lib/ — Supabase, OpenAI, 유틸 (C 담당)
/src/types/ — 타입 정의 (수정 시 팀 알림)
